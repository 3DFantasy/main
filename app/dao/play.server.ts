...
export async function playCreate({
    data,
}: PlayCreateInput): Promise<typeof play> {
...
export async function playUpdate({
    where,
    data,
}: PlayUpdateInput): Promise<typeof play> {
...
export async function playFindMany({
    where,
}: PlayFindManyInput): Promise<typeof play> {
...
export async function playFindUnique({
    where,
}: PlayFindUniqueInput): Promise<typeof play> {
    const play = await db.play.findMany({
        where,
        select: {
            id: true,
