...
export const meta: MetaFunction = () => {
	return [{ title: '3DF - Settings' }, { name: '3DF', content: 'Modify your 3DF application settings' }]
}
...
export default function Settings() {
	...
	return (
		<div className='mt-4 flex flex-row'>
			<ListboxWrapper>
				<Listbox aria-label='Actions' selectedKeys={selectedKeys} selectionMode='single' variant='flat'>
					<ListboxItem
						key='account'
					...
					<ListboxItem
						...
						onPress={() => setSelectedKeys(new Set(['notifications']))}
					>
						Notifications
					</ListboxItem>
				</Listbox>
