...
export const meta: MetaFunction = () => {
    return [
        ...
        {
            name: '3DF',
            content: 'Modify your 3DF notification application settings',
        },
    ]
}
...
export default function SettingsNotifications() {
    ...
    return (
        <div>
            ...
            <p className="mb-2">
                Select the teams that you would like to continue to receive new
                depth chart email notifications for:
            </p>
            <CheckboxGroup
                defaultValue={[]}
                value={selected}
